...
public class Checkhotels extends JFrame implements Runnable {
    ...
    JLabel caption;
    public void run(){
        String[] text= new String[] {"NIRAAMAYA RETREATS","RASS DEVIGARH","HOTEL TAJ","THE LEELA PALACE","KOHINOOR","RADDSION BLUE HOTEL","CLASSICO HOTEL","THE BAY CLUB","MADRIN ORIENTED HOTEL","NOVOTEL "};
